        ...
        <div class="flex-wrap container-fluid d-flex align-items-center justify-content-between flex-sm-nowrap">
            ...
            <div class="flex-wrap mr-1 d-flex align-items-center">
                ...
                <div class="flex-wrap mr-5 d-flex align-items-baseline">
                    <!--begin::Page Title-->
                    <h5 class="my-1 mr-5 text-dark font-weight-bold">Информация о накладном</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group fv-plugins-icon-container">
                                        <label for="date_e">Дата отправки:</label>
                                        <input value="{{$overhead->from_name}}" disabled type="text" placeholder="Дата отправки"
                                               name="date_e"
                                               autocomplete="off"
                        ...
                        <div class="mb-0 text-right form-group">
                            <a href="{{route('admin.evaluate.index')}}" class="btn btn-sm btn-primary">Назад</a>
            ...
            <div class="printNaklDateAndInfo" style="width: 50%;display: flex;">
                ...
                <div class="printNaklLogoAndTel" style="display: flex; flex-direction: column;margin-left: 15px;width: 57%;position:relative;">
                    ...
                    <div class="phone44" style="position: absolute;
                                        right: 65px;
                                        top: 15px;">
                        <p style="margin:0;font-size:8px;">+77073424299</p>
                        <p style="margin:0;font-size:8px;">info@postalservice.kz</p>
                    </div>
                </div>
            </div>
        </div>
