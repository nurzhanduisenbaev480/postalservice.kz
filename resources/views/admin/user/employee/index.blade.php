        ...
        <div class="flex-wrap container-fluid d-flex align-items-center justify-content-between flex-sm-nowrap">
            ...
            <div class="flex-wrap mr-1 d-flex align-items-center">
                ...
                <div class="flex-wrap mr-5 d-flex align-items-baseline">
                    <!--begin::Page Title-->
                    <h5 class="my-1 mr-5 text-dark font-weight-bold">Сотрудники</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="p-0 my-2 mr-5 breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold font-size-sm">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('admin.users.employee.index')}}" class="text-muted">Сотрудники</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <div class="mx-auto col-lg-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">Список сотрудников</h5>
            </div>
                                ...
                                @if(isset($users))
                                    ...
                                    @foreach($users as $user)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('admin.users.employee.edit')}}?id={{$user->id}}"
                                                   class="btn btn-primary btn-sm">Редактировать</a>
                                                <a href="{{route('admin.users.employee.delete', ['client_id'=>$user->id])}}" class="btn btn-danger btn-sm">-</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
