                ...
                <div class="flex-wrap mr-5 d-flex align-items-baseline">
                    ...
                    <ul class="p-0 my-2 mr-5 breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            @if($role->id == 5)
                                <a href="{{route('admin.cabinet.overhead')}}" class="text-muted">Заявка</a>
                            @else
                                <a href="{{route('admin.overheads.index')}}" class="text-muted">Заявка</a>
                            @endif
                        </li>
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('admin.overheads.show')}}?overhead_id={{$overhead->id}}" class="text-muted">Информация о заявке</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="card">
            <div class="card-header" style="display:flex;">
				...
				<a href="{{route('admin.overheads.edit1')}}?overhead_id={{$overhead->id}}"
				   class="btn btn-primary ml-3">Редактировать</a>
            </div>
            <div class="card-body">
                <div class="container-fluid" style="padding: 0;">
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if(strlen(trim($overhead->from_city)) > 2)
											<input value="{{$overhead->from_city}}"
												   disabled name="from_city" id="from_city"
                                               class="form-control">
										@else
										@if(App\Models\City::find($overhead->from_city) != null)
											<input value="{{App\Models\City::find($overhead->from_city)->city_name}}" disabled
												   name="from_city" id="from_city"
                                               class="form-control">
										@else
										<input value="Не указан город" disabled
												   name="from_city" id="from_city"
                                               class="form-control">
										@endif
										@endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
										...
										@if(strlen(trim($overhead->to_city)) > 2)
											<input value="{{$overhead->to_city}}"
												   disabled name="to_city" id="to_city"
                                               class="form-control">
										@else
											@if(is_null(App\Models\City::find($overhead->to_city)))
												<input value="{{$overhead->to_city}}"
													   ...
													   class="form-control">
											@else
												<input value="{{App\Models\City::find($overhead->to_city)->city_name}}"
												   disabled name="to_city" id="to_city"
                                               class="form-control">
											@endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group fv-plugins-icon-container">
                                        ...
                                        <input value="{{$overhead->date_e}}" disabled type="text" placeholder="Дата доставки"
                                               name="date_e"
                                               autocomplete="off"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea disabled
                                                  class="form-control" name="description" id="description">{{$overhead->description}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                        ...
                        <div class="mb-0 text-right form-group">
                            ...
                            @if($role->id == 5)
                                <a href="{{route('admin.cabinet.overhead')}}" class="btn btn-sm btn-primary">Назад</a>
                            @else
                                <a href="{{route('admin.overheads.index')}}" class="btn btn-sm btn-primary">Назад</a>
                            @endif
...
@section('admin-script')
    <script>
        ...
        function printOverhead(){
            ...
            printFrom.find('.city p').text($('#from_city').val());
