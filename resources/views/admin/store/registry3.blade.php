            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="left_actions" style="display:flex;">
						<button class="btn btn-primary btn-sm mr-2" id="select_all">Выбрать все</button>
                                    ...
                                    <td>
                                        <p class="overheads_p">
                                            @if(strlen($overhead->to_city) > 2)
                                                {{$overhead->to_city}}
                                            @else
                                                {{\App\Models\City::find($overhead->to_city)->city_name}}
                                            @endif
                                        </p>
                                    </td>
                                    <td>
...
@section('admin-script')
    <script>
        ...
        $("#overhead_code_5").change(function(){
            ...
            $.ajax({
                url: '{{route("admin.store.getOverhead5")}}',
                method: 'GET',
                data: {overhead_code: overhead_code},
                success: function(result){
                    let res = JSON.parse(result);
