            ...
            <div class="flex-wrap mr-1 d-flex align-items-center">
                ...
                <div class="flex-wrap mr-5 d-flex align-items-baseline">
                    ...
                    <ul class="p-0 my-2 mr-5 breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold font-size-sm">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('admin.courier.index')}}" class="text-muted">Заявки</a>
                        </li>
    ...
    <div class="mx-auto col-lg-12 col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">Мои заявки</h5>
            </div>
                                                    ...
                                                    <ul style="list-style: none;padding: 0;" class="order_action">
                                                        <li class="order_action_item">
                                                            @if($order->status_id == 2)
                                                                <a href="{{route('admin.courier.accept')}}?order_id={{$order->id}}" 
																   class="btn btn-success">Принять</a>
                                                            @elseif($order->status_id == 3)
                                                            <a href="{{route('admin.courier.take2')}}?order_id={{$order->id}}" 
																	   class="btn btn-sm btn-warning">Присвоить</a>
																
                                                            @elseif($order->status_id == 4)
                                                                <a href="{{route('admin.courier.finish')}}?order_id={{$order->id}}" 
																   class="btn btn-dark">Завершить</a>
                                                            @endif
