                ...
                <div class="flex-wrap mr-5 d-flex align-items-baseline">
                    ...
                    <ul class="p-0 my-2 mr-5 breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('admin.courier.overhead')}}" class="text-muted">Заявка</a>
                        </li>
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('admin.courier.edit')}}" class="text-muted">Редактировать накладной</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <div class="mx-auto col-lg-12">
        ...
        <div class="card">
            ...
            <form class="form-horizontal fv-plugins-bootstrap fv-plugins-framework"
                ...
                <input type="hidden" value="{{$overhead->overhead_code}}" name="overhead_code">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="payment" id="payment" class="form-control">
                                            @if($overhead->speed == 'Отправителем')
                                            ...
                                            @elseif($overhead->speed == 'Получателем')
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                               value="{{$overhead->mass}}" placeholder="123" name="mass" id="mass">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                               value="{{$overhead->length}}" placeholder="123" name="length" id="length">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                               value="{{$overhead->width}}" placeholder="123" name="width" id="width">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                               value="{{$overhead->height}}" placeholder="123" name="height" id="height">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="place" id="place" value="{{$overhead->place}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mb-0 text-right form-group">
                            ...
                            <a href="{{route('admin.courier.overhead')}}" class="btn btn-secondary">Назад</a>
                        </div>
                    </div>
                </div>
            </form>
