                ...
                <div class="col-md-6">
					...
					<div class="row mt-5">
						<div class="col-md-12">
							...
							<button type="button" class="btn btn-danger add_registry"
                       				data-toggle="modal" data-target="#exampleModalLong" 
									id="create_new">Новая сборная</button>
                                    ...
                                    @if($overhead->status_id == 14)
                                        <tr class="table-danger visible">
											<td style="padding: 7px;">
												<input type="checkbox" class="form-control check_overhead" data="{{$overhead->id}}">
                                            ...
                                            <td class="actions_road">
                                                ...
                                                <a href="{{route('admin.group.set')}}?id={{$overhead->id}}"
...
@section('admin-script')
    <script>
		...
		$('.add_registry').click(function(){
            let items = $('#t-none tr .check_overhead:checked');
            let data = [];
