...
<head>
    ...
    <!--end::Layout Themes-->
    <link rel="shortcut icon" href="{{ asset('public/assets/dashboard/media/logos/favicon.ico') }}" />
    <style>
...
<div class="d-flex flex-column flex-root">
    ...
    @include('inc.cabinet_nav')

    <!--begin::Wrapper-->
        <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">

        @include('inc.cabinet_sidenav')
        <!--end::Header-->
