...
<div class="dashboard-content">
    ...
    <div class="container dasboard-container">
        ...
        <div class="dashboard-title fl-wrap">
            <div class="dashboard-title-item"><span>Добавить накладной</span></div>
            ...
            <form action="#" method="GET">
                ...
                <div class="dasboard-widget-title fl-wrap" id="sec1">
					...
					<div class="form-group">
						<label for="other_company">Выберите компанию</label>
						<select class="form-control" id="other_company">
							<option value="96">M-Lombard</option>
							<option value="97">MK-Lombard</option>
						</select>
					</div>
					@endif
                </div>
                    ...
                    <div class="custom-form">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" id="from_name" name="from_name" placeholder="ФИО" value="{{$user->name}}">
                            </div>
                            <div class="col-sm-4">
                                <label for="from_company">Компания
                                    <span class="dec-icon"><i class="far fa-house-flood"></i></span>
                                </label>
                                <input type="text" id="from_company" name="from_company" placeholder="Компания" 
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <input type="text" id="from_address" name="from_address" placeholder="Адрес отправителя"
                                       value="{{$userInfo->address}}">
                            </div>
                            <div class="col-sm-8">
                                <label for="from_phone">Телефон <span class="dec-icon"><i class="far fa-phone"></i> </span> </label>
                                <input type="text" id="from_phone" name="from_phone" placeholder="+7(777)987654"
...
<div id="printNakl" style="width:800px;margin-bottom:20px;display: none;">
        ...
        <div class="printNaklHeader" style="display: flex;">
            <div class="printNaklTitle" style="width: 50%;display: flex;align-items:center;">
                <div style="padding: 0;font-size:12px;">Транспортная накладная:</div>
        ...
        <div style="font-size:12px;border-bottom: 1px dashed black;text-align:center;">POSTALSERVICE</div>
    </div>
@endsection
<script>
